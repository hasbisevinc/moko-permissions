...
```groovy
dependencies {
    commonMainApi("dev.icerock.moko:permissions:0.18.0-slow")
    
    // compose multiplatform
    commonMainApi("dev.icerock.moko:permissions-compose:0.18.0-slow") // permissions api + compose extensions
    
    commonTestImplementation("dev.icerock.moko:permissions-test:0.18.0-slow")
}
```
